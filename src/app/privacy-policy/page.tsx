          ...
          <div className="w-full px-10 py-16">
            <div className="m-auto max-w-5xl">
              <div className="flex flex-col gap-y-6">
                <h2 className="break-words py-4 font-bold">Privacy Policy</h2>
                <p className="break-words text-left  text-xl">
                  By visiting BartekPiekarz.com, you are consenting to our
                  privacy policy.
                </p>
                <h3 className="break-words py-4 font-bold">Overview</h3>
                <p className="break-words text-left  text-xl">
                  BartekPiekarz.com is committed to protecting your privacy
                  online. This Privacy Policy describes the information we
                  collect through this website (the “Site”), and how we collect
                  and use such information.
                  <br />
                  The terms “we,” “us,” and “our” refer to Bartek Piekarz
                  Holdings LLC. The terms “user,” “you,” and “your” refer to
                  site visitors, customers, and any other users of the site.
                  <br />
                  Use of BartekPiekarz.com, including all materials presented
                  herein and all online services provided by Bartek Piekarz
                  Holdings LLC is subject to the following Privacy Policy. This
                  Privacy Policy applies to all site visitors, customers, and
                  all other users of the site. By using the Site or Service, you
                  agree to this Privacy Policy, without modification, and
                  acknowledge reading it.
                </p>
                <h3 className="break-words py-4 font-bold">Cookies</h3>
                <p className="break-words text-left  text-xl">
                  ...
                  <br />
                  (b) personalization – we use cookies to store information
                  ...
                  <br />
                  (d) analysis – we use cookies to help us to analyze the use
                  ...
                  .
                  <br />
                  Please note that blocking cookies may have a negative impact
                  on the functions of many websites, including our Site. Some
                  features of the Site may cease to be available to you.
                </p>
                <h3 className="break-words py-4 font-bold">Advertising</h3>
                <p className="break-words text-left  text-xl">
                  By using this Site, you consent to the use of such cookies and
                  the sharing of data captured by such cookies with Google, and
                  our other third-party partners. You can view, delete or add
                  ...
                  . You can also opt out of the network cookie using those
                  settings or using the Network Advertising Initiative’s
                  ...
                  . However, these opt-out mechanisms themselves use cookies,
                  and if you clear the cookies from your browser your opt-out
                  will not be maintained.
                  <br />
                  For European Economic Area Residents
                  <br />
                  If you reside in a country in the European Economic Area
                  (EEA), then under the GDPR and applicable data protection laws
                  you have the rights, among other things, to access your
                  personal data, have us erase it, and/or restrict its further
                  processing. If you wish to access or delete your personal data
                  (if any) maintained by us or AdThrive related to advertising
                  on the Site, you can contact AdThrive at info@adthrive.com. If
                  you wish to see a list of the advertising partners we work
                  with or change which of those partners track your behavior
                  using cookies, click the ad preferences icon. (Available in
                  the EU.)
                </p>
                <h3 className="break-words py-4 font-bold">
                  Affiliated Sites, Linked Sites, and Advertisements
                </h3>
                <p className="break-words text-left  text-xl">
                  BartekPiekarz.com expects its partners, advertisers, and
                  affiliates to respect the privacy of our users. Be aware,
                  however, that third parties, including our partners,
                  ...
                  frame on BartekPiekarz.com pages, certain content that is
                  actually created or hosted by a third party. Also, through
                  BartekPiekarz.com you may be introduced to, or be able to
                  access, information, websites, features, contests, or
                  sweepstakes offered by other parties. BartekPiekarz.com is not
                  responsible for the actions or policies of such third parties.
                  You should check the applicable privacy policies of those
                  third parties when providing information on a feature or page
                  ...
                  served by third parties and may include cookies that enable
                  the advertiser to determine whether you have seen a particular
                  advertisement before. Other features available on our site may
                  offer services operated by third parties and may use cookies
                  or other technology to gather information. BartekPiekarz.com
                  does not control the use of this technology by third parties
                  or the resulting information, and are not responsible for any
                ...
                <p className="break-words text-left  text-xl">
                  ...
                  place of the alleged infringement. Please contact us via email
                  at:
                  <br />
                  <a
                    href="mailto:contact@bartekpiekarz.com"
                    className="text-blue-600 underline"
                  >
                ...
                <p className="break-words text-left  text-xl">
                  BartekPiekarz.com reserves the right to change this policy at
                  any time. Please check this page periodically for changes.
                  Your continued use of our site following the posting of
                ...
                <h3 className="break-words py-4 font-bold">Contact</h3>
                <p className="break-words text-left  text-xl">
