...
function Coding({ children }: { children: React.ReactNode }) {
  const { data: posts, isLoading, error } = api.post.getCodingPosts.useQuery();
  ...
  return (
    <main className="flex min-h-screen flex-col items-end lg:flex-row">
      {/* Top Bar on Mobile*/}
      <div className="flex w-full flex-col items-center border-b border-primary/35 lg:hidden bg-white">
        <hr className="w-full" />
        <div className="my-3 flex w-full items-center justify-center px-4 bg-white">
          <input
            type="text"
            name="search"
            id="search"
            className="w-full p-1 focus:outline-none focus:ring-transparent"
            placeholder="Search through posts bg-white"
      ...
      {/* Side bar */}
      <div className="hidden h-full min-h-screen border-l border-primary/35 lg:block lg:w-[39%] xl:w-[30%] bg-white">
        <hr className="w-full" />
        <div className="my-3 flex w-full items-center justify-center px-4 bg-white">
          <input
            type="text"
            name="search"
            id="search"
            className="w-full p-1 focus:outline-none focus:ring-transparent bg-white"
