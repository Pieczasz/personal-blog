    ...
    <div className="flex flex-col ">
      <div className="flex flex-col gap-y-6 px-10 py-16">
        ...
        <p className="text-xl">
          ...
          it and be like those people on TikTok and YouTube who tell you that
          making money is easy, life is easy, and everything will always go as
          you would like it to go.
        </p>
        <p className="text-xl">
          I am here to show my perspective on life, work, and how I want to
          become successful.
        </p>
      </div>
